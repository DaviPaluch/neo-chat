            ...
            <Dialog open={newChannelModal} onOpenChange={(open) => {
                ...
                >
                    <DialogHeader className="flex-shrink-0 mb-3">
                        <DialogTitle className="text-lg font-semibold">Crie um grupo novo</DialogTitle>
                        <DialogDescription className="text-sm">
                            Adicione as informações do grupo.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="flex flex-col items-center mb-2 flex-shrink-0">
                        ...
                        <input
                            ...
                            className="hidden"
                        />
                        <p className="text-xs text-gray-400 mt-0.5">Imagem do grupo (opcional)</p>
                    </div>
